...
We're so thankful you're considering contributing to this open source project! If you're unsure about anything, just
...
4. Mention any other content guidelines the project adheres to (e.g. a plain-language guide, accessibility guidelines, etc...)
...
the project's mirror. For the most part this process should be transparent to the
project users, but it does have some implications for how pull requests are
merged into the codebase.

When you submit a pull request on GitHub, it will be reviewed by the project
community (both inside and outside of the project's mirror), and once the changes are
approved, your commits will be brought into the project's mirror's internal system for
...
privately rather than in a public issue — see [SECURITY.md](SECURITY.md) for how to report
and our disclosure window.

### Privacy

For how this project handles personal data, see [PRIVACY.md](PRIVACY.md).

## License

This project is released under the license declared in [LICENSE](LICENSE). By submitting a
pull request or issue, you agree that your contribution is released under that license.
