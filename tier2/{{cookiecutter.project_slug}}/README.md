...
<!--
DPG Standard Indicator 1 (Relevance to the SDGs) — gating for DPG eligibility, mandatory
from Tier 2 on. Be specific about the target (e.g. 4.1, 3.8, 16.6), not just the goal.
-->
...
<!-- DPG Standard Indicator 3 (Clear Ownership). -->

- **Owner:** {{ cookiecutter.project_org }} _(state the type: government, non-profit, company, foundation, individual; and country of legal establishment)_
- **Maintainers:** see [COMMUNITY.md](COMMUNITY.md).
- **Copyright / trademark / terms:** _link as applicable._

## Standards & Best Practices

<!-- DPG Standard Indicator 8 (entry). -->

This project aims to follow the [Principles for Digital Development](https://digitalprinciples.org/)
and open security/quality best practices:

- Working toward the [OpenSSF Best Practices Badge](https://www.bestpractices.dev/) (passing level).
- CI, automated tests, dependency review, and secret scanning run in `.github/`.
- Open standards adhered to (data formats, protocols, APIs): _list with validators._
